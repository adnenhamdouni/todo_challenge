...
public class Todo {
    ...
    public void setSDescription(String pSDescription) {
        mSDescription = pSDescription;
    }

    public void setTimeCreation(Date pDTimeCreation) {
        mTimeCreation = pDTimeCreation;
    }

    public void setBIsDone(boolean pBIsDone) {
        mBIsDone = pBIsDone;
    }
